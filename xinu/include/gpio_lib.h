...
/* 92 pins: 46 p8 followed by 46 p9 */
typedef enum {
    P0,
    P1,
    P2,
...
typedef struct {
    pinname_t pin;
    portpin_t pp;
    bbb_adc_pin_t adcpin;
}pintoportpin_t;


/* 92 pins: 46 p8 followed by 46 p9 */
extern pintoportpin_t pinmap[93];
 ...
 * 	@Source : AM335x Technical Reference Manual ,p
    age 1123~1127 , Table 9-10. CONTROL_MODULE REGISTERS
 *
...
/* for mapping alignment . BBBIO_CM_WKUP_ADDR is not aligned of page boundary in 4k page .*/
